...
enum Personality: String, Codable, CaseIterable, Sendable {
    ...
    var shortDescription: String {
        switch self {
        case .balanced:
            return "Combines skeptical analysis with constructive suggestions."
        case .generalist:
    ...
    var promptSnippet: String {
        switch self {
        case .balanced:
            return "Strike a balance between skeptical analysis and constructive support. First, briefly acknowledge the strengths of the user's ideas and what's working well. Then, thoughtfully examine potential risks, hidden assumptions, or weak points—but frame concerns as opportunities for improvement rather than pure criticism. Finally, offer practical suggestions or alternatives that address the risks you've identified. Be honest and direct, but maintain a collaborative tone that helps the user move forward confidently."
        case .generalist:
