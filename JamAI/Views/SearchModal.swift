...
struct SearchModal: View {
    ...
    private var searchBarView: some View {
        HStack(spacing: 10) {
            ...
            SelectableTextField(text: $viewModel.query, placeholder: "Search for text in nodes...")
                .font(.system(size: 15))
...
// MARK: - Selectable TextField

/// A TextField wrapper that properly supports Command+A for select all
